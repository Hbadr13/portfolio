...
const Footer = () => {
    ...
    return (
        <div className=' '>
            <div className="mt-20 max-w-6xl mx-auto bg-gradient-to-r from-indigo-500 to-blue-400  md:rounded-[80px] shadow-lg py-16 px-8 text-center animate-fade-in-up">
