...
const Seniordeveloper = () => {
    return (
        <main className="w-full  uppercase relative h-[600px] flex justify-center">
            <div className=" absolute  top-0 w-full h-full z-0 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className=" w-full" height="688" viewBox="0 0 1440 688" fill="none">
            ...
            <div className="MainText     h-full w-1/2 flex justify-center items-center ">
                senior <br />
                full stack<br />
                developer
            </div>
