...
const Navbar = () => {
    ...
    return (
        <main className='w-full bg-pf-g'>

            <div className="h-[250px] w-full relative bg-sky-700 rounded-[4px]">
                <div className="absolute left-[60px]  rounded-full -bottom-[80px] w-[180px] h-[180px]  bg-white p-1">
            ...
            <div className="px-12">
                ...
                <div className="mt-6 space-y-4">
                    <div className="flex items-start space-x-2">
                        <div className="text-4xl font-bold">Hamza Badr</div>
                    ...
                    <div className="text-pf-grey-text">
